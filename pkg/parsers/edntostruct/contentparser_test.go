...
type MixedSome struct {
	Field map[MixedSomeKeyUnnamespaced]MixedSomeSub "json:\"field\" edn:\"some/field\""
}

type MixedSomeKeyUnnamespaced struct {
...
`,
		...
		{
			name: "should prevent namespace collision of unnamespaced sub edn",
			args: &args{
				packagePath: "example.com/some/package/path",
				prefix:      "SimpleNamespaced",
				ednContent:  []byte(`{:namespace/id "13", :namespace/amount 23.19, :namespace/cents 2319, :namespace/valid? false, :namespace/sub {:value 1}}`),
			},
			want: &want{
				result: `// Code generated by endtostruct DO NOT EDIT
package path
...
type SimpleNamespacedNamespace struct {
	...
	Cents  int64                                 "json:\"cents\" edn:\"namespace/cents\""
	ID     string                                "json:\"id\" edn:\"namespace/id\""
	Sub    SimpleNamespacedNamespaceUnnamespaced "json:\"sub\" edn:\"namespace/sub\""
	Valid  bool                                  "json:\"valid?\" edn:\"namespace/valid?\""
}

type SimpleNamespacedNamespaceUnnamespaced struct {
	Value int64 "json:\"value\" edn:\"value\""
}
`,
			},
		},
