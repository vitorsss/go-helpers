...
`,
		...
		{
			name: "should parse with struct keys",
			args: &args{
				packagePath: "example.com/some/package/path",
				prefix:      "Mixed",
				ednSchema:   []byte(`{:namespace/map {{:status Int} (constrained Str not-empty)}}`),
			},
			want: &want{
				result: `// Code generated by endtostruct DO NOT EDIT
package path

type MixedNamespace struct {
	Map map[MixedNamespaceKeyUnnamespaced]string "json:\"map\" edn:\"namespace/map\""
}

type MixedNamespaceKeyUnnamespaced struct {
	Status int64 "json:\"status\" edn:\"status\""
}
`,
			},
		},
